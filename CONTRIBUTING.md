...
This repo packages [Fulcrum](https://github.com/cculianu/Fulcrum) for StartOS.
...
Fulcrum runs the upstream `cculianu/fulcrum` Docker image. To track a new upstream release:
...
3. Rebuild (`make`), sideload the `.s9pk`, and confirm it starts and reaches the **Electrum (SSL)** interface.
